...
@section('title', 'Сотрудники CRM 2')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <form action="{{ route('crm3.employees.index') }}" method="GET" class="d-flex" style="max-width: 300px;">
        <input 
            type="search" 
            name="search" 
    ...
    <a href="{{ route('crm3.employees.create') }}" class="btn btn-primary shadow-sm px-4 py-2 fw-semibold rounded-pill">
        Добавить сотрудника
    </a>
</div>
  ...
  <tbody>
    ...
    <tr class="align-middle">
      ...
      <td class="text-center" style="white-space: nowrap;">
        <a href="{{ route('crm3.employees.show', $employee) }}" class="btn btn-sm btn-info me-1 shadow-sm rounded-pill" title="Просмотр">
          <i class="bi bi-eye"></i> Просмотр
        </a>
        <a href="{{ route('crm3.employees.edit', $employee) }}" class="btn btn-sm btn-warning text-white me-1 shadow-sm rounded-pill" title="Редактировать">
        ...
        <div class="modal fade" id="deleteModal-{{ $employee->id }}" tabindex="-1" 
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="{{ route('crm3.employees.destroy', $employee->id) }}" method="POST">
                @csrf
                @method('DELETE')
