...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
    <form action="{{ route('crm3.orders.index') }}" method="GET" class="d-flex" style="max-width: 300px;">
        <input 
            type="search" 
            name="search" 
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('crm3.orders.create') }}" class="btn btn-primary shadow-sm px-4 py-2 fw-semibold rounded-pill">
            Новый заказ
        </a>
    </div>
</div>
