...
<form action="{{ route('crm3.customers.store') }}" method="POST" class="shadow-sm p-4 bg-white rounded">
    @csrf
    ...
    <a href="{{ route('crm3.customers.index') }}" class="btn btn-secondary ms-2 rounded-pill">Отмена</a>
</form>
