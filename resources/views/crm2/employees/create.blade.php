...
<form action="{{ route('crm2.employees.store') }}" method="POST" class="w-100" style="max-width: 600px;">
    @csrf
    ...
    <a href="{{ route('crm2.employees.index') }}" class="btn btn-secondary rounded-pill px-4 py-2 ms-2">Отмена</a>
</form>
@endsection
