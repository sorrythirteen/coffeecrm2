    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm2.customers.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm2.employees.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm2.menu.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm2.orders.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm2.workhours.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
</div>
