    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm1.customers.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm1.menu.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-body text-center">
                ...
                <a href="{{ route('crm1.orders.index') }}" class="btn btn-primary w-100">Перейти</a>
            </div>
        </div>
    </div>
</div>
